...
echo.
echo.IPv4-hosts更新地址：
echo. https://raw.githubusercontent.com/googlehosts/hosts/master/hosts-files/hosts
echo. https://coding.net/u/scaffrey/p/hosts/git/raw/master/hosts-files/hosts
echo. 
echo.-----------------------------------------------------------
echo.请选择使用：
echo.
